...
export interface IState {
    cartProducts: TCartProductsItem[] | [],
    cartProductsData: TCartProductsDataItem[] | [],
...
type TCartProductsItem = {
    quantity: number,
    productId: number,
}

type TCartProductsDataItem = {
    id: number,
    price: number,
    product: {
        colors: [],
...
export const store = createStore<IState>({
    ...
    mutations: {
        ...
        updateCartProductAmount(state, { productId, quantity }: TCartProductsItem) {
    ...
    actions: {
        ...
        loadCart(context) {
            ...
            return new Promise((resolve) => setTimeout(resolve, 1500)).then(() => axios
        ...
        addProductToCart(context, { productId, amount }) {
            return new Promise((resolve) => setTimeout(resolve, 1000)).then(() => axios
